...
import { getBriefNotes } from '@/lib/notes';
import { isUserLogin } from '@/lib/userAuth';
import { router } from 'expo-router';


export default function CustomWaterfall() {
  type NoteItem = {
    nid: number;
    title: string;
    image: string;
        ...
        {searchMode ? (
          <View>
            <View style={styles.header}>
              <TouchableOpacity style={{padding: 4}} onPress={() => setSearchMode(false)}>
          ...
          <View>
            <View style={styles.header}>
              ...
              <TouchableOpacity style={{padding: 4}} onPress={() => setSearchMode(true)}>
                <Feather name="search" size={28} color="#666" />
              </TouchableOpacity>
            </View>
          </View>
